...
import space.zeinab.demo.kafka.topology.CustomStateProcessor;
import space.zeinab.demo.kafka.topology.RelationalDbStoreBuilder;
...
public class KafkaConfig {
    ...
    public Topology kafkaTopology(JdbcTemplate jdbcTemplate) {
        ...
        StoreBuilder<StateStore> customStoreBuilder = new RelationalDbStoreBuilder("customStateStore", jdbcTemplate);
        topology.addSource("source", "input-topic")
                .addProcessor("statefulProcessor", () -> new CustomStateProcessor("customStateStore"), "source")
                .addStateStore(customStoreBuilder, "statefulProcessor")
                .addSink("sink", "output-topic", "statefulProcessor");
